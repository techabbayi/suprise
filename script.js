 ...
 let canvas = document.getElementById('stage');
  ...
  if(value=="abhi"){
    ...
    console.log("User entered abhi");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://i1.wp.com/godofindia.com/wp-content/uploads/2017/08/i-am-so-sorry-pic.jpg`;
    const hoverUrl = "./abhi.jpeg";
  ...
  if(value=="crush3"){
    console.log("User entered crush3");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/dj8Gtpa.jpg`;
  ...
  if(value=="crush4"){
    console.log("User entered crush4");
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/dj8VWf2.jpg`;
    const hoverUrl = "https://m.media-amazon.com/images/I/61fagD4zWKL.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
